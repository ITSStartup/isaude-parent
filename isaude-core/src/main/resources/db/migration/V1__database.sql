...
CREATE  TABLE IF NOT EXISTS `camilo_itsisaude`.`EXPEDIENTE_MEDICO` (
  ...
  PRIMARY KEY (`ID`) ,
  INDEX `fk_EXPEDIENTE_MEDICO_INSTITUICAO_MEDICA1_idx` (`INSTITUICAO_MEDICA_ID` ASC) ,
  INDEX `fk_EXPEDIENTE_MEDICO_MEDICO1_idx` (`MEDICO_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `camilo_itsisaude`.`AGENDA_MEDICO` (
  ...
  INDEX `fk_AGENDA_MEDICO_EXPEDIENTE_MEDICO1_idx` (`EXPEDIENTE_MEDICO_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `camilo_itsisaude`.`AGENDA_CONSULTA_MEDICA` (
  ...
  `STATUS` VARCHAR(45) NULL ,
  PRIMARY KEY (`ID`) ,
  INDEX `fk_AGENDA_CONSULTA_MEDICA_AGENDA_MEDICO1_idx` (`AGENDA_MEDICO_ID` ASC) ,
  CONSTRAINT `fk_AGENDA_CONSULTA_MEDICA_AGENDA_MEDICO1`
...
CREATE  TABLE IF NOT EXISTS `camilo_itsisaude`.`AGENDAMENTO_CONSULTA_MEDICA_PACIENTE` (
  ...
  PRIMARY KEY (`ID`) ,
  INDEX `fk_AGENDAMENTO_CONSULTA_MEDICA_PACIENTE1_idx` (`PACIENTE_ID` ASC) ,
  INDEX `fk_AGENDAMENTO_CONSULTA_MEDICA_PACIENTE_AGENDA_CONSULTA_MED_idx` (`AGENDA_CONSULTA_MEDICA_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `camilo_itsisaude`.`INSTITUICAO_MEDICA_HAS_MEDICO` (
  ...
  INDEX `fk_INSTITUICAO_MEDICA_has_MEDICO_MEDICO1_idx` (`MEDICO_ID` ASC) ,
  INDEX `fk_INSTITUICAO_MEDICA_has_MEDICO_INSTITUICAO_MEDICA1_idx` (`INSTITUICAO_MEDICA_ID` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `camilo_itsisaude`.`MEDICO_HAS_ESPECIALIDADE_MEDICA` (
  ...
  INDEX `fk_MEDICO_has_ESPECIALIDADE_MEDICA_ESPECIALIDADE_MEDICA1_idx` (`ESPECIALIDADE_MEDICA_ID` ASC) ,
  INDEX `fk_MEDICO_has_ESPECIALIDADE_MEDICA_MEDICO1_idx` (`MEDICO_ID` ASC) ,
